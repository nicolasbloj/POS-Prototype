...
public class HibernateConfiguration {
	...
	public DataSource dataSource() {
		...
		try {
			...
			dataSource.setAcquireIncrement(environment.getRequiredProperty("c3p0.acquire_increment", Integer.class));
			...
			dataSource.setMaxIdleTime(environment.getRequiredProperty("c3p0.max_idle_time", Integer.class));
